...
aiBuilt: false
metrics:
  - { value: "4 wks", label: "Zero to prototype" }
  - { value: "2", label: "Core flows built" }
...
![IA Map](/images/projects/miirrai/iamap.png)
*IA Map — a high-level view of the information architecture, mapping the relationships between vendors, orders, and documents*

The IA map she produced clarified the relationships between vendors, orders, and documents at a system level, giving the engineering team a clear blueprint and the investors a coherent mental model of what they were funding.
...
![Figma sketch — Documents view](/images/projects/miirrai/figma-sketch.png)
*The Figma sketch that mapped out the Documents view structure — hierarchy, nav, table layout — before moving directly into Base44*

This meant every design decision was immediately testable in a real interface. When something didn't work, it got fixed in the product, not re-drawn in a design file. The speed came from collapsing the gap between "how it should look" and "how it actually behaves."

The core product flow — document upload → AI processing → data review → export — was designed to demystify the "black box" of AI. At every stage, users can see what the system is doing. The export phase was especially deliberate: two paths (CSV for legacy systems, Shopify for modern e-commerce) directly addressed the split between traditional and digital-native fashion buyers.

![Core product flow](/images/projects/miirrai/product-flow.jpg)
*Document upload → AI processing → data review → export — the full 8-step flow*

The live interactive demo is accessible at [miirr-copy-af9493e4.base44.app](https://miirr-copy-af9493e4.base44.app).
...
![Product UI — live in Base44](/images/projects/miirrai/product-ui.jpg)
*The same Documents view, built and live in Base44 — vendor documents centralised with filtering by date, order type, and status*

The landing page in particular was structured to translate complex AI capabilities into a clear value proposition, positioning miirr.ai as infrastructure for modern fashion buying rather than a novelty feature.
